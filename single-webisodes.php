        ...
        <footer>
          ...
          <script type="text/javascript">
            ...
            function displayNavigation() {
              ...
              // $.ajax({
              //   "url": url,
              //   data: {"start":<?php echo get_post_meta($post->ID,'episode',true)-1; ?>,"pager":1},
              //   dataType: "text/json",
              ...
              //     var html='';
              //     // console.log(webisodes, pager);
              //     // console.log("ID: " + <?php echo $post->ID; ?>);
              //     // console.log("Episode: " + "<?php echo get_post_meta($post->ID,'episode',true)-1; ?>");
              //     // console.log("Artist: " + webisodes[0].post_title);
              //     // console.log("Previous: " + pager.previous);
              //     // console.log("Episode: " + webisodes[0].episode);
              //     // console.log("Next: " + pager.next);
              //     // console.log(webisodes[0]);
              //     html+='<li><a href="http://webseries.guitarcenter.dev/webisode/?start='+ (pager.previous-1) +'&pager=1&redirect=1" class="nav"><img class="nav-arrow" src="<?php echo get_stylesheet_directory_uri(); ?>/images/assets/arrow-left.png"></a></li>';
              //     html+='<li><a id="episode-title">Episode '+ (webisodes[0].episode) +' of '+ pager.last_page +' </a></li>';
              //     html+='<li><a href="http://webseries.guitarcenter.dev/webisode/?start='+ (pager.next-1) +'&pager=1&redirect=1" class="nav"><img class="nav-arrow" src="<?php echo get_stylesheet_directory_uri(); ?>/images/assets/arrow-right.png"></a></li>';
              //     $(".right").html(html);
              //   }
              // });
            }
